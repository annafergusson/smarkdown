...
function decode(){
   ...
   $('.code-blank').each(function(index) {
      $(this).before("<div><button class='blank' id='" + index + "'><i class='fa fa-play' aria-hidden='true'></i>&nbsp;<small>Run code</small></button><img class='blanker mini' style='display:none; width:20px' id='" + index + "' src='smarkdown/mini-cat.gif' /></div><div style='clear:both'></div>");
